...
import { IPC_Request_Dispatcher } from "./app/backend/ipc-request-dispatcher";
import { FileTool } from "./app/backend/file-tool";
import { IPC_Action_Broker } from "./app/backend/ipc-action-broker";
...
FileTool.getApp_UserDataPath(); // Ensure path exists
...
const createWindow = (): void => {
  ...
  IPC_Action_Broker.handle_actions(mainWindow);
...
async function dispatch_ipc_requests() {
  const ipcd: IPC_Request_Dispatcher = new IPC_Request_Dispatcher();
